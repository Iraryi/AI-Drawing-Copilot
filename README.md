...
| 区域构图 | 关系描述引导后的结果 |
| --- | --- |
| ![区域构图](docs/images/02-composition-map.png) | ![关系描述引导后的结果](docs/images/04-relation-guided-result.png) |
...
| 常见偏移 | 更严重的结构失控 |
| --- | --- |
| ![位置提示仍发生偏移](docs/images/03-coordinate-prompt-limit.png) | ![位置提示出现严重结构失控](docs/images/05-coordinate-prompt-failure.png) |
